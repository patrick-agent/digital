export const defaultSiteSettings = {
  ...
  branding: {
    ...
    logoUrl: "/logo.png",
    adminTitle: "Tachy Artist",
    adminSubtitle: "Admin CMS",
    navCtaLabel: "Listen Now",
    navCtaHref: "/#music",
  },
  navigation: [
    { href: "/#hero", id: "hero", label: "Home", enabled: true },
    { href: "/#about", id: "about", label: "About", enabled: true },
    { href: "/#music", id: "music", label: "Music", enabled: true },
    { href: "/#latest-ep", id: "latest-ep", label: "Lastest EP", enabled: true },
    { href: "/#donation", id: "donation", label: "Support", enabled: true },
    { href: "/contact", id: "contact", label: "Contact", enabled: true },
  ],
  homepage: {
    hero: {
      kicker: "Artist • Producer • Digital Marketer",
      titlePrefix: "Welcome to",
      titleAccent: "Tachy's",
      titleSuffix: "World",
      description: "Listen to Tachy's latest track on Spotify, Youtube, Apple Music,...",
      primaryCtaLabel: "Khám phá hành trình",
  ...
  footer: {
    ...
    navigationLinks: [
      ...
      { label: "Latest EP.", href: "#latest-ep", enabled: true },
    ],
    otherLinks: [
      ...
      { label: "Bio Music", href: "/bio-music", enabled: true },
      { label: "Terms", href: "/terms", enabled: true },
      { label: "Contact Me", href: "/contact", enabled: true },
      { label: "Privacy", href: "/privacy", enabled: true },
    ],
    copyrightName: "TACHY",
  },
  socialLinks: {
    facebook: "https://facebook.com/tachy.ngo/",
    instagram: "https://instagram.com/tachy.ngo/",
    youtube: "https://youtube.com/@TachyNgo",
    spotify: "https://open.spotify.com/artist/6k6IAy0p8zl0cfzBqGvX9G",
    linkedin: "https://linkedin.com/in/tachyngo/",
    tiktok: "https://tiktok.com/@tachy.ngo",
    appleMusic: "https://music.apple.com/gb/artist/tachy/1818075133",
    amazonMusic: "https://music.amazon.com/artists/B0FBMQJR61/tachy",
  },
  theme: {
    preset: "ngx-admin-classic-dark",
    primaryColor: "#a855f7",
...
export function mergeSiteSettings(settings = {}) {
  return mergeDeep(defaultSiteSettings, settings)
}
